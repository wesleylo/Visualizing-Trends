/*
Instagram Responsive Grid (https://github.com/cmaseattle/instagram-grid)
*/
var igrid = (function(trend) {
  ...
  */ 
  function init(config) {
    ...
    var elements = document.getElementsByClassName('insta-block');
  ...
  */ 
  ...
  //var url = params._local ? params._local : 'https://api.instagram.com/v1/users/'+params._userID+'/media/recent/?client_id='+params._clientid+'&count='+params.total;
    var url = "https://api.instagram.com/v1/tags/" + trend + "/media/recent?access_token=183873234.1305eca.151dbb82269a4a5f9908c99ba40447c6&callback=?";
